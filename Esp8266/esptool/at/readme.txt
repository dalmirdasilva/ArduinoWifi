./esptool.py --port /dev/ttyACM0 write_flash 0x0000 boot_v1.4\(b1\).bin 0x01000 512+512/user1.1024.new.2.bin 0x3fc000 esp_init_data_default.bin 0x7E000 blank.bin
